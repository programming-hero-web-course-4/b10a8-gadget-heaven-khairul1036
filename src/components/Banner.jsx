...
const Banner = () => {
    return (
        <>
        <div className="bg-[#9538E2] text-center pt-16 pb-72 mx-10 rounded-es-xl rounded-ee-xl">
        ...
        <div className="w-1/2 mx-auto rounded-xl border-2 border-white bg-white bg-opacity-25 p-5 relative bottom-52">
